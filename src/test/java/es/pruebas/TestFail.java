...
public class TestFail {
	...
	@Test
	/*Accedo al login con credenciales incorrectos*/
	...
	public void testTest() {
		try {
			...
			String loginPassFail = propiedades.getProperty("loginPassFail", "valoresComunes.properties");
			String pantallaFAIL = propiedades.getProperty("pantallaFAIL", "valoresComunes.properties");
			...
			login.completaLogin(usuario, loginPassFail);
			login.acceder();
			
			//Comprobación vista actual
			actual = login.compruebaError();
			Assert.assertEquals(pantallaFAIL, actual);
